var tr=Object.create;var Me=Object.defineProperty;var rr=Object.getOwnPropertyDescriptor;var nr=Object.getOwnPropertyNames;var ir=Object.getPrototypeOf,sr=Object.prototype.hasOwnProperty;var Te=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+t+'" is not supported')});var or=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var ar=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of nr(e))!sr.call(t,i)&&i!==r&&Me(t,i,{get:()=>e[i],enumerable:!(n=rr(e,i))||n.enumerable});return t};var lr=(t,e,r)=>(r=t!=null?tr(ir(t)):{},ar(e||!t||!t.__esModule?Me(r,"default",{value:t,enumerable:!0}):r,t));var Rt=or((ce,jt)=>{(function(t,e){typeof ce=="object"&&typeof jt<"u"?e(ce):typeof define=="function"&&define.amd?define(["exports"],e):(t=t||self,e(t.sourcemapCodec={}))})(ce,function(t){"use strict";for(var e={},r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",n=0;n<r.length;n++)e[r.charCodeAt(n)]=n;function i(o){for(var c=[],p=[],f=[0,0,0,0,0],m=0,d=0,g=0,b=0;d<o.length;d++){var y=o.charCodeAt(d);if(y===44)s(p,f,m),m=0;else if(y===59)s(p,f,m),m=0,c.push(p),p=[],f[0]=0;else{var _=e[y];if(_===void 0)throw new Error("Invalid character ("+String.fromCharCode(y)+")");var v=_&32;if(_&=31,b+=_<<g,v)g+=5;else{var k=b&1;b>>>=1,k&&(b=b===0?-2147483648:-b),f[m]+=b,m++,b=g=0}}}return s(p,f,m),c.push(p),c}function s(o,c,p){p===4?o.push([c[0],c[1],c[2],c[3]]):p===5?o.push([c[0],c[1],c[2],c[3],c[4]]):p===1&&o.push([c[0]])}function a(o){for(var c=0,p=0,f=0,m=0,d="",g=0;g<o.length;g++){var b=o[g];if(g>0&&(d+=";"),b.length!==0){for(var y=0,_=[],v=0,k=b;v<k.length;v++){var $=k[v],I=l($[0]-y);y=$[0],$.length>1&&(I+=l($[1]-c)+l($[2]-p)+l($[3]-f),c=$[1],p=$[2],f=$[3]),$.length===5&&(I+=l($[4]-m),m=$[4]),_.push(I)}d+=_.join(",")}}return d}function l(o){var c="";o=o<0?-o<<1|1:o<<1;do{var p=o&31;o>>>=5,o>0&&(p|=32),c+=r[p]}while(o>0);return c}t.decode=i,t.encode=a,Object.defineProperty(t,"__esModule",{value:!0})})});var B=Symbol.for("#__init__"),Ue=Symbol.for("#__initor__"),cr=Symbol.for("#__inited__"),We=Symbol.for("#__hooks__");var ur=Symbol.for("#meta"),pe=Symbol.for("imba");var pr=Symbol.for("#matcher");var ri={SUPERCALLS:1<<3,CONSTRUCTOR:1<<4},D={IsExtension:1<<0,IsTag:1<<1,HasDescriptors:1<<2,HasSuperCalls:1<<3,HasConstructor:1<<4,HasFields:1<<5,HasMixins:1<<6,HasInitor:1<<7,HasDecorators:1<<8,IsObjectExtension:1<<9,IsMixin:1<<10},W=new Map,fr=globalThis[pe]||(globalThis[pe]={counter:0,classes:W});function U(t,e={}){return W.has(t)||W.set(t,{symbol:Symbol(t.name),parent:Object.getPrototypeOf(t.prototype)?.constructor,for:t,uses:null,inits:null,id:fr.counter++,...e}),W.get(t)}function Le(t,e){return t===e||e?.[pr]?.(t)}function C(t){return t?.toIterable?.()||t}function mr(t,e){if(!t||!e)return!1;if(t.get)return e.get===t.get;if(t.set)return e.set===t.set;if(t.value)return t.value===e.value}function Ne(t,e,r,n={}){let i=t.constructor;!r&&e&&(r=Object.getOwnPropertyDescriptors(e),delete r.constructor,r[B]&&(console.warn(`Cannot define plain fields when extending class ${i.name}`),delete r[B]));let s=U(i);if(s&&s.augments){let a=new Map;for(let l of Object.keys(r)){let o=Object.getOwnPropertyDescriptor(t,l);for(let c of s.augments){let p=a.get(c);p||a.set(c,p={});let f=Object.getOwnPropertyDescriptor(c.prototype,l);f&&!mr(o,f)?console.warn("wont extend",l,f,o):p[l]=r[l]}}for(let[l,o]of a)Object.keys(o).length&&Ne(l.prototype,null,o)}return Object.defineProperties(t,r),t}function fe(t,e){let r=U(t),n=U(e),i=n.parent;for(;i&&U(i)?.flags&D.IsMixin;){fe(t,i),i=null;break}if(i&&!(t.prototype instanceof i))throw new Error(`Mixin ${e.name} has superclass not present in target class`);if(!n.augments){n.augments=new Set;let a=n.ref=Symbol(e.name),l=Object[Symbol.hasInstance];e.prototype[a]=!0,Object.defineProperty(e,Symbol.hasInstance,{value:function(o){return this===e?o&&!!o[a]:l.call(this,o)}})}if(t.prototype[n.ref])return t;if(n.uses)for(let a of n.uses)fe(t,a);n.augments.add(t),r.uses||(r.uses=[]),r.uses.push(e);let s=Object.getOwnPropertyDescriptors(e.prototype);return delete s.constructor,s[B]&&(r.inits||(r.inits=[]),r.inits.push(e.prototype[B]),delete s[B]),Object.defineProperties(t.prototype,s),e?.mixed instanceof Function&&e.mixed(t),t}var A={cache:{},self:null,target:null,proxy:new Proxy({},{apply:(t,e,...r)=>A.target[e].apply(A.self,r),get:(t,e)=>Reflect.get(A.target,e,A.self),set:(t,e,r,n)=>Reflect.set(A.target,e,r,A.self)})};function M(t,e,r,n,i=null){let s=Object.getPrototypeOf(t.prototype),a=(n&(D.HasMixins|D.IsExtension))==D.HasMixins,l;if(a&&(W.set(t,W.get(s.constructor)),s=Object.getPrototypeOf(s)),i){let c=n&D.IsObjectExtension?i:i.prototype,p=U(t);if(p.uses){i===c&&console.warn("Cannot extend object with mixins");for(let f of p.uses)fe(i,f)}return n&D.HasSuperCalls&&(A.cache[e]=Object.create(Object.getPrototypeOf(c),Object.getOwnPropertyDescriptors(c))),Ne(c,t.prototype),i}let o=s?.constructor;if(l=U(t,{symbol:e}),Object.defineProperty(t,ur,{value:l,enumerable:!1,configurable:!0}),r&&t.name!==r&&Object.defineProperty(t,"name",{value:r,configurable:!0}),l.flags=n,n&D.HasConstructor&&(t.prototype[Ue]=e),l.uses)for(let c of l.uses)c.mixes?.(t);return o?.inherited instanceof Function&&o.inherited(t),t}function Y(t,e){t[Ue]===e&&(t[cr]?.(),t[We]&&t[We].inited(t))}import{readFileSync as dr}from"fs";import{parseAsset as gr}from"imba/compiler";function hr(t,e){let r,n=gr({body:t});return r=`export default /* @__PURE__ */ Object.assign({
	type: 'svg'
},`+JSON.stringify(n)+")"}function me(t={}){let e=new Map;return{name:"vite-plugin-imba-svg",transform:async function(r,n,i){if(n.endsWith(".svg")){let s=e.get(n);if(!s){let a=dr(n,"utf-8");s=await hr(a,n),e.set(n,s)}return s}}}}import{normalizePath as Kn}from"vite";import*as Yt from"esbuild";import{extname as ui,win32 as br,posix as Ve,isAbsolute as yr,resolve as vr}from"path";import xr from"picomatch";function wr(t){return Array.isArray(t)}function ze(t){return wr(t)?t:t==null?[]:[t]}var Z=function(e){return e.split(br.sep).join(Ve.sep)};function Or(t,e){if(e===!1||yr(t)||t.startsWith("*"))return Z(t);let r=Z(vr(e||"")).replace(/[-^$*+?.()|[\]{}]/g,"\\$&");return Ve.join(r,Z(t))}var Be=function(e,r,n){let i=n&&n.resolve,s=o=>o instanceof RegExp?o:{test:c=>{let p=Or(o,i);return xr(p,{dot:!0})(c)}},a=ze(e).map(s),l=ze(r).map(s);return function(c){if(typeof c!="string"||/\0/.test(c))return!1;let p=Z(c);for(let f=0;f<l.length;++f)if(l[f].test(p))return!1;for(let f=0;f<a.length;++f)if(a[f].test(p))return!0;return!a.length}},_r="break case class catch const continue debugger default delete do else export extends finally for function if import in instanceof let new return super switch this throw try typeof var void while with yield enum await implements package protected static interface private public",$r="arguments Infinity NaN undefined null true false eval uneval isFinite isNaN parseFloat parseInt decodeURI decodeURIComponent encodeURI encodeURIComponent escape unescape Object Function Boolean Symbol Error EvalError InternalError RangeError ReferenceError SyntaxError TypeError URIError Number Math Date String RegExp Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array Map Set WeakMap WeakSet SIMD ArrayBuffer DataView JSON Promise Generator GeneratorFunction Reflect Proxy Intl",Ir=new Set(`${_r} ${$r}`.split(" "));Ir.add("");import{normalizePath as He}from"vite";import*as qe from"fs";import{URL as bi,URLSearchParams as Ke,pathToFileURL as yi}from"url";var ee="/@fs/",Sr=process.platform==="win32";function Pr(t){let e=t.split("?",2),r=e[0],n=e[1];return{filename:r,rawQuery:n}}function Cr(t,e,r,n,i,s){let a=Rr(r);if(a.url||a.raw)return;let l=Fr(e,n),o=jr(e,n,"style");return{id:t,filename:e,normalizedFilename:l,cssId:o,query:a,timestamp:i,ssr:s}}var Er=/\?(?!.*[\/|\}])/;function Je(t){let[e,r]=t.split(Er,2);return r?Object.fromEntries(new Ke(r)):null}function jr(t,e,r){let n=["imba",`type=${r}`];return r==="style"&&n.push("lang.css"),kr(t,e)?t=e+t:t.startsWith(ee)&&(t=Sr?t.slice(ee.length):t.slice(ee.length-1)),`${t}?${n.join("&")}`}function Rr(t){let e=Object.fromEntries(new Ke(t));for(let r in e)e[r]===""&&(e[r]=!0);return e}function Fr(t,e){return Dr(He(t),e)}function kr(t,e){return t.startsWith(ee)?!1:qe.existsSync(e+t)}function Dr(t,e){return t.startsWith(e+"/")?t.slice(e.length):t}function Ar(t,e,r){let n=Be(t,e);return i=>n(i)&&r.some(s=>{let[a]=i.split("?",2);return a.endsWith(s)})}function Ge(t){let{include:e,exclude:r,extensions:n,root:i}=t,s=He(i),a=Ar(e,r,n);return(l,o,c=Date.now())=>{let{filename:p,rawQuery:f}=Pr(l);if(a(p))return Cr(l,p,f,s,c,o)}}var te={reset:[0,0],bold:[1,22],dim:[2,22],italic:[3,23],underline:[4,24],inverse:[7,27],hidden:[8,28],strike:[9,29],black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],gray:[90,39],grey:[90,39],brightΞred:[91,39],brightΞgreen:[92,39],brightΞyellow:[93,39],brightΞblue:[94,39],brightΞmagenta:[95,39],brightΞcyan:[96,39],brightΞwhite:[97,39],bgΞblack:[40,49],bgΞred:[41,49],bgΞgreen:[42,49],bgΞyellow:[43,49],bgΞblue:[44,49],bgΞmagenta:[45,49],bgΞcyan:[46,49],bgΞwhite:[47,49],bgΞgray:[100,49],bgΞgrey:[100,49],bgΞbrightΞred:[101,49],bgΞbrightΞgreen:[102,49],bgΞbrightΞyellow:[103,49],bgΞbrightΞblue:[104,49],bgΞbrightΞmagenta:[105,49],bgΞbrightΞcyan:[106,49],bgΞbrightΞwhite:[107,49]},Qe={};for(let t=0,e=Object.keys(te),r=e.length,n;t<r;t++){n=e[t];let[i,s]=te[n];Qe[n]=function(a){return"\x1B["+i+"m"+a+"\x1B["+s+"m"}}var H=Qe;for(let t=0,e=Object.keys(te),r=e.length,n;t<r;t++){n=e[t];let[i,s]=te[n];String.prototype.__defineGetter__(n,function(){return"\x1B["+i+"m"+this+"\x1B["+s+"m"})}String.prototype.f=function(t){return"\x1B[38;5;"+t+"m"+this+"\x1B[39m"};String.prototype.b=function(t){return"\x1B[48;5;"+t+"m"+this+"\x1B[49m"};import Mr from"debug";var de=["debug","info","warn","error","silent"],Ye="vite-plugin-imba",ge={debug:{log:Mr(`vite:${Ye}`),enabled:!1,isDebug:!0},info:{color:H.cyan,log:console.log,enabled:!0},warn:{color:H.yellow,log:console.warn,enabled:!0},error:{color:H.red,log:console.error,enabled:!0},silent:{enabled:!1}},Xe="info";function Tr(t){if(t===Xe)return;let e=de.indexOf(t);if(e>-1){Xe=t;for(let r=0;r<de.length;r++)ge[de[r]].enabled=r>=e}else Ze(ge.error,`invalid log level: ${t} `)}function Ze(t,e,r){!t.enabled||(t.isDebug?r!==void 0?t.log(e,r):t.log(e):(t.log(t.color(`${new Date().toLocaleTimeString()} [${Ye}] ${e}`)),r&&t.log(r)))}function re(t){let e=ge[t],r=Ze.bind(null,e),n=new Set,i=function(s,a){n.has(s)||(n.add(s),r.apply(null,[s,a]))};return Object.defineProperty(r,"enabled",{get(){return e.enabled}}),Object.defineProperty(r,"once",{get(){return i}}),r}var u={debug:re("debug"),info:re("info"),warn:re("warn"),error:re("error"),setLevel:Tr};function ne(t,e,r){let{emitCss:n,onwarn:i,isBuild:s}=r,a=!s&&r.experimental?.sendWarningsToBrowser,l=s?Nr:Lr,o=[],c=e?.filter(m=>!Wr(m,s,n)),p=Ur(e,s),f=[...c,...p];if(a){let m=l;l=d=>{o.push(d),m(d)}}if(f.forEach(m=>{i?i(m,l):l(m)}),a){let m={id:t.id,filename:t.filename,normalizedFilename:t.normalizedFilename,timestamp:t.timestamp,warnings:o,allWarnings:f,rawWarnings:e};u.debug(`sending imba:warnings message for ${t.normalizedFilename}`),r.server?.ws?.send("imba:warnings",m)}}function Wr(t,e,r){return!r&&t.code==="css-unused-selector"||!e&&et(t)}function et(t){return t.code==="css-unused-selector"&&t.message.includes('"*"')}function Ur(t,e){let r=[];if(!e){let n=t.filter(i=>et(i));if(n.length>0){let i=n[n.length-1];r.push({...i,code:"vite-plugin-imba-css-no-scopable-elements",message:"No scopable elements found in template. If you're using global styles in the style tag, you should move it into an external stylesheet file and import it in JS. See https://github.com/imbajs/vite-plugin-imba/blob/main/docs/faq.md#where-should-i-put-my-global-styles."})}}return r}function Lr(t){u.info.enabled&&u.info(q(t))}function Nr(t){u.warn.enabled&&u.warn(q(t),t.frame)}function q(t){let e=[];return t.filename&&e.push(t.filename),t.start&&e.push(":",t.start.line,":",t.start.column),t.message&&(e.length>0&&e.push(" "),e.push(t.message)),e.join("")}import{compile as Hr}from"imba/compiler";import it from"fs";import*as tt from"crypto";var he=Object.create(null),zr=12;function rt(t){if(he[t])return he[t];let e=tt.createHash("md5");e.update(t);let r=Br(e.digest("base64")).slice(0,zr);return he[t]=r,r}var nt={"+":"-","/":"_","=":""},Vr=new RegExp(`[${Object.keys(nt).join("")}]`,"g");function Br(t){return t.replace(Vr,e=>nt[e])}var qr=/<script [^>]*lang=["']?([^"' >]+)["']?[^>]*>/,Kr=(t,e)=>async function(n,i,s){let{filename:a,normalizedFilename:l,cssId:o,ssr:c}=n,{emitCss:p=!0}=s,f=[],m={...s.compilerOptions,filename:a,generate:c?"ssr":"dom",format:"esm",resolveColors:!0,sourcePath:a,vite:!0,sourcemap:s.compilerOptions.sourcemap??"extern",...t};if(s.hot&&s.emitCss){let h=`s-${rt(l)}`;u.debug(`setting cssHash ${h} for ${l}`),m.cssHash=()=>h}c&&m.enableSourcemap!==!1&&(typeof m.enableSourcemap=="object"?m.enableSourcemap.css=!1:m.enableSourcemap={js:!0,css:!1});let d=await s.experimental?.dynamicCompileOptions?.({filename:a,code:i,compileOptions:m});d&&u.debug.enabled&&u.debug(`dynamic compile options for  ${a}: ${JSON.stringify(d)}`);let g=d?{...m,...d}:m;g.config=g,g.styles="extern",g.platform="browser",g.vite=!0;let b=n.query;g.platform=c?"node":"browser",b.worker?g.platform="worker":b.web&&(g.platform="browser"),s.server?.config?.mode=="test"&&s.server?.config?.test?.environment=="node"&&(g.platform="node");let y=globalThis.VITE_IMBA_CACHE,_=[],v=`${a}-${g.platform}-vite2`,k=it.existsSync(a)?it.statSync(a).mtimeMs:0,I=((h,O)=>{let w=Hr(h,O),E=w.sourcemap;return{js:{code:w.js,dependencies:[],map:E},css:{code:w.css},warnings:w.warnings,errors:w.errors}})(i,g);if(I.erroredΦ)throw I;return p&&I.css.code&&(I.js.code+=`
/*__css_import__*/import ${JSON.stringify(o)};
`),!c&&e&&(I.js.code=e({id:a,compiledCode:I.js.code,hotOptions:s.hot,compiled:I,originalCode:i,compileOptions:g})),I.js.dependencies=f,{filename:a,normalizedFilename:l,lang:i.match(qr)?.[1]||"js",compiled:I,ssr:c,dependencies:f}};function st(t,e){return Kr(e)}import{normalizePath as un}from"vite";import{createRequire as Jr}from"module";import be from"path";import ie from"fs";import{pathToFileURL as ot}from"url";var Gr,ye=["imba.config.js","imbaconfig.json","imba.config.json"],Qr=new Function("path","timestamp",'return import(path + "?t=" + timestamp).then(m => m.default)'),Xr=new Function("path","timestamp",'return import(path + "?t=" + timestamp, {assert: {type: "json"}}).then(m => m.default)');async function at(t,e){if(e?.configFile===!1)return;let r=Yr(t,e);if(r){let n;if(r.endsWith(".json"))try{let i=await Xr(ot(r).href,ie.statSync(r).mtimeMs);if(i!=null)return{...i,configFile:r};throw new Error(`invalid export in ${r}`)}catch(i){u.error(`failed to import config ${r}`,i),n=i}if(r.endsWith(".js")||r.endsWith(".mjs")||r.endsWith(".json"))try{let i=await Qr(ot(r).href,ie.statSync(r).mtimeMs);if(i!=null)return{...i,configFile:r};throw new Error(`invalid export in ${r}`)}catch(i){u.error(`failed to import config ${r}`,i),n=i}if(!r.endsWith(".mjs"))try{let i=import.meta.url?Gr??(Gr=Jr(import.meta.url)):Te;delete i.cache[i.resolve(r)];let s=i(r);if(s!=null)return{...s,configFile:r};throw new Error(`invalid export in ${r}`)}catch(i){u.error(`failed to require config ${r}`,i),n||(n=i)}throw n}}function Yr(t,e){let r=t?.root||process.cwd();if(e?.configFile){let n=be.isAbsolute(e.configFile)?e.configFile:be.resolve(r,e.configFile);if(!ie.existsSync(n))throw new Error(`failed to find imba config file ${n}.`);return n}else{let n=ye.map(i=>be.resolve(r,i)).filter(i=>ie.existsSync(i));if(n.length===0){u.debug(`no imba config found at ${r}`);return}else n.length>1&&u.warn(`found more than one imba config file, using ${n[0]}. you should only have one!`,n);return n[0]}}var Zr=["module","jsnext:main","jsnext"],lt=["imba",...Zr],ve=[],ct=[];import pn from"path";import L from"path";import ut from"fs";import{createRequire as en}from"module";function xe(t,e=!0){u.debug(`findImbaDependencies: searching imba dependencies in ${t}`);let r=L.join(t,"package.json");if(!ut.existsSync(r)){if(e){let s=process.cwd();if(t!==s)return u.debug(`no package.json found in vite root ${t}`),xe(s,!1)}return u.warn("no package.json found, findRootImbaDependencies failed"),[]}let n=mt(t);if(!n)return[];let i=[...Object.keys(n.dependencies||{}),...Object.keys(n.devDependencies||{})].filter(s=>!an(s));return pt(i,t)}function pt(t,e,r=[]){let n=[],i=en(`${e}/package.json`),s=t.map(a=>ft(a,i)).filter(Boolean);for(let{pkg:a,dir:l}of s){let o=tn(a);if(!!o&&(n.push({name:a.name,type:o,pkg:a,dir:l,path:r}),o==="component-library"&&a.dependencies)){let c=Object.keys(a.dependencies),p=c.filter(f=>r.includes(f));p.length>0&&(u.warn.enabled&&u.warn("skipping circular imba dependencies in automated vite optimizeDeps handling",p.map(f=>r.concat(f).join(">"))),c=c.filter(f=>!r.includes(f))),r.length===3&&u.debug.once(`encountered deep imba dependency tree: ${r.join(">")}`),n.push(...pt(c,l,r.concat(a.name)))}}return n}function ft(t,e){try{let r=`${t}/package.json`,n=e(r);return{dir:L.dirname(e.resolve(r)),pkg:n}}catch(r){u.debug.once(`dependency ${t} does not export package.json`,r);try{let n=L.dirname(e.resolve(t));for(;n;){let i=mt(n,!0);if(i&&i.name===t)return{dir:n,pkg:i};let s=L.dirname(n);if(s===n)break;n=s}}catch(n){u.debug.once(`error while trying to find package.json of ${t}`,n)}}u.debug.once(`failed to resolve ${t}`)}function mt(t,e=!1){let r=L.join(t,"package.json");try{return JSON.parse(ut.readFileSync(r,"utf-8"))}catch(n){!e&&u.warn.enabled&&u.warn(`failed to parse ${r}`,n)}}function tn(t){return rn(t)?"component-library":nn(t)?"js-library":void 0}function rn(t){return!!t.imba}function nn(t){return!!t.dependencies?.imba||!!t.peerDependencies?.imba}var sn=["@lukeed/uuid","@playwright/test","@imbajs/vite-plugin-imba","@imbajs/kit","autoprefixer","cookie","dotenv","esbuild","eslint","jest","mdsvex","playwright","postcss","prettier","imba","imba-check","imba-hmr","imba-preprocess","tslib","typescript","vite","vitest","__vite-browser-external"],on=["@fontsource/","@postcss-plugins/","@rollup/","@imbajs/adapter-","@types/","@typescript-eslint/","eslint-","jest-","postcss-plugin-","prettier-plugin-","rollup-plugin-","vite-plugin-"];function an(t){return sn.includes(t)||on.some(e=>e.startsWith("@")?t.startsWith(e):t.substring(t.lastIndexOf("/")+1).startsWith(e))}function dt(t,e){let r=ft(t,e);if(!r)return!1;let n=r.pkg;if(n.module||n.exports)return!1;if(n.main){let s=L.extname(n.main);return!s||s===".js"||s===".cjs"}else try{return e.resolve(`${t}/index.js`),!0}catch{return!1}}import{createRequire as fn}from"module";import{compile as Ki}from"imba/compiler";var gt="Compilation Error";function se(t){if(!t?.errors?.length)return{name:"Compilation error",id:t._sourcePath,message:q({message:`Compilation error: ${t.message}`})};let e=t?.errors?.length?t.errors[0]:{diagnostics:[{source:gt}],options:{filename:t._sourcePath},range:{start:{line:1,column:1}},message:t?.toString},n=`${e.source||e?.diagnostics[0]?.source||gt} error`,i=t.options.filename,{line:s,character:a}=e.range.start,l={line:s+1,column:a,file:i},o=q({message:e.message}),c=t.sourceCode+`
