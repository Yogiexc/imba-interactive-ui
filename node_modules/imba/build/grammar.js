...
var grammar = {
  ...
  Block: [
    ...
    o("INDENT TERMINATOR OUTDENT", function() {
      return new Block([]).indented(A1, A3);
    })
  ],
  Line: [
    o("CSSDeclaration"),
  ...
  StyleColor: [
    ...
    o("COLORMIX ( StyleFunctionArgs )", function() {
      return new StyleColorMix(A1, A3.setEnds(A2, A4)).set({ params: A3 }).setEnds(A1, A4);
    })
  ],
  StyleTerm: [
    o("StyleParens"),
    ...
    o("CSSFUNCTION ( StyleFunctionArgs )", function() {
      return new StyleFunction(A1, A3.setEnds(A2, A4)).setEnds(A1, A4);
    }),
  ...
  TagBody: [
    ...
    o("INDENT TERMINATOR OUTDENT", function() {
      return new TagBody([]).indented(A1, A3);
    }),
